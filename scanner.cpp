...
// 2(b) scanner reads in tokens and each token returns a token, which
// indicates what kind of token ot os
...
// 2(b) define a couple of operator for printing out scanner results
